...
tar -C "${LOCAL_ROOT}" \
  -czf "${RELEASE_TAR}" \
  index.html mini-eng.html xiaoguwen.html app.js mini-eng.js xiaoguwen.js server.mjs package.json minimaths-icon.svg site.webmanifest icon-192.png icon-512.png apple-touch-icon.png
